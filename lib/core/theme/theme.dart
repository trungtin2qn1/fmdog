...
import 'package:fmdog/utils/custom_colors.dart';
...
extension ColorSchemeExtension on ColorScheme {
  ...
  Color get disableTextColorBtn => brightness == Brightness.light
      ? CustomColors.lightDisableTextColorBtn
      : CustomColors.darkDisableTextColorBtn;

  Color get disableBgColorBtn => brightness == Brightness.light
  ...
  Color get homeScreenBgColor => brightness == Brightness.light
      ? CustomColors.lightHomeScreenBgColor
      : CustomColors.darkHomeScreenBgColor;

  Color get toggleBgColor => brightness == Brightness.light
