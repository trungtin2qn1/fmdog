...
class Timeline {
  ...
  factory Timeline.current() {
    return Timeline.currentMonth();
  }

  Timeline previousWeek() {
    var previousDateTime = this.startTime.subtract(const Duration(days: 7));
  ...
  Timeline nextWeek() {
    var previousDateTime = this.startTime.add(const Duration(days: 7));
    DateTime startTime = findFirstDateOfTheWeek(previousDateTime);
    DateTime endTime = findLastDateOfTheWeek(previousDateTime);
    return Timeline(startTime: startTime, endTime: endTime);
  }
